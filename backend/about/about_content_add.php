...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Add About Content</span>
    </nav>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="m-0 text-center">Add About Content</h5>
                    </div>
                    <div class="card-body">
                        <form action="about_content_add_process.php" method="POST">

...
//counter
$counter_sql = "SELECT * FROM counters";
    ...
    <div class="sl-pagebody">
        ...
        <div class="row mb-3">
            <div class="col-sm-6 col-xl-3">
                <div class="card pd-20 pd-sm-25">
                    <div class="d-flex align-items-center">
                        <span class="tx-gray-500 mr-3"><i class="fas fa-stopwatch-20 tx-40"></i></span>
                        <div class="mg-l-15">
                            <p class="tx-uppercase tx-11 tx-spacing-1 tx-medium tx-gray-600 mg-b-8">Total Fact Counters</p>
                            <h3 class="tx-bold tx-lato mg-b-0"><?= mysqli_num_rows($counter_query) ?></h3>
                        </div>
                    </div>
                </div><!-- card -->
            </div>
                ...
                <div class="card pd-20 pd-sm-25">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="mg-l-15">
                            ...
                            <h3 class="tx-bold tx-lato mg-b-0"><?= mysqli_num_rows($message_query) ?></h3>
                        </div>
                    </div>
                </div><!-- card -->
            </div>

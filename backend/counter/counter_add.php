            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="m-0 text-center">Add Counter</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="counter_add_process.php" method="POST">
                            <div class="row form-group">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <input type="number" class="form-control" id="amount" name="amount" value="<?= show_session_data('amount') ?>">
                                </div>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-sm" name="add">Add Counter</button>
                            </div>
                        </form>
                    </div>
                </div>

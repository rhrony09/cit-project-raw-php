                        ...
                        <table class="table table-bordered align-middle text-center">
                            ...
                            <tbody>
                                <?php foreach ($query as $key => $image) : ?>
                                    <tr>
                                        <td><?= ++$key ?></td>
                                        <td><img style="max-width: 100px;" src="../../assets/frontend/img/banner/<?= $image['image'] ?>" alt="banner image"></td>
                                        ...
                                        <td>
                                            <?php if ($image['status'] == 0) : ?>
                                                <a href="banner_image_active.php?id=<?= $image['id'] ?>" class="btn btn-info btn-sm">Active This</a>
                                                <?php if ($admin['role'] >= 2) : ?>
